...
function Index() {
  return (
    <div>
      ...
      This is the team website for Regis Jesuit&apos;s Robotics Team. The
      information provided by RJ&apos;s Robotics Team (&quot;we,&quot;
      &quot;us,&quot; or &quot;our&quot;) on (insert website) (the
      &quot;Site&quot;) is for general informational purposes only. We are not
      an official Site of Regis Jesuit High School and all content of this Site
      is managed, edited and created by RJ&apos;s Robotics Team members and/or
      coaches. All information on the Site is provided in good faith, however,
      ...
      ON THE SITE. YOUR USE OF THE SITE AND YOUR RELIANCE ON ANY INFORMATION ON
      THE SITE IS SOLELY AT YOUR OWN RISK. <br />
      -------- <br />
      ...
      experiences are personal to those particular users and may not necessarily
      be representative of all users. We do not claim, and you should not
      assume, that all users will have the same experiences. The testimonials on
      the Site are submitted in various forms such as text, audio and/or video
      and are reviewed by us before being posted. They appear on the Site
      verbatim as given by the users, except for the correction of grammar or
      ...
      testimonials belong solely to the individual user and do not necessarily
      reflect the views and opinions or the Robotics team or of Regis Jesuit
      High School.
    </div>
  );
}
